          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    children: [
                      const Text("Nike Shoes", style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.black),),
                      ...
                      Row(
                        ...
                        children: [
                          const Text("\$70.00", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    width: 175,
                    child: 
                    Image.network("https://app.vectary.com/website_assets/636cc9840038712edca597df/636cc9840038713d9aa59ac2_UV_hero.jpg",fit: BoxFit.fill,),
                  ),
                  const SizedBox(width: 10,),
            ...
            const Row(
              ...
              children: [
                ...
                Text("\$5.00  ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
            ...
            Column(
              ...
              children: [
                ElevatedButton(style:const ButtonStyle(backgroundColor: WidgetStatePropertyAll(Color.fromARGB(255, 29, 16, 215),),), onPressed: (){}, child: const Text("Checkout for \$480.00", style: TextStyle(color: Colors.white,fontSize: 20),),),
